...
export const create_visual_initiative_order = (): InitiativeOrderVisual => ({
    create_creature: ({creature, initiative, index}: {
        creature: Creature,
...
export type InitiativeOrderVisual = {
    create_creature: (props: { creature: Creature, initiative: ExprNumberResolved, index: number }) => CreatureInitiativeVisual
}

export type CreatureInitiativeVisual = {
